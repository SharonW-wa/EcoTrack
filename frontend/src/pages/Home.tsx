...
const features = [
  { icon: Recycle, title: 'Waste Categorization', description: 'Learn how to properly sort and categorize different types of waste for effective recycling.', color: 'from-red-400 to-red-600', link: '/waste-categories' },
  { icon: MapPin, title: 'Find Recycling Centers', description: 'Locate the nearest recycling facilities with GPS-enabled search and directions.', color: 'from-blue-400 to-blue-600', link: '/recycling-centers' },
  { icon: Gift, title: 'Earn Rewards', description: 'Get reward points for every recycling activity and redeem them for exciting benefits.', color: 'from-purple-400 to-purple-600', link: '/rewards' },
  { icon: BookOpen, title: 'Eco Education', description: 'Access educational content and inspiring quotes to promote sustainable living.', color: 'from-green-400 to-green-600', link: '/waste-categories' },
];
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight mb-6">
                Recycle Today for a <span className="text-yellow-300">Greener Tomorrow</span>
              </h1>
              <p className="text-lg lg:text-xl text-green-100 mb-8 max-w-xl">
                Join Kenya's leading waste management platform. Earn rewards, find recycling centers, and make a positive impact on our environment.
              </p>
                ...
                <div className="relative bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
                  <div className="grid grid-cols-2 gap-4">
                    {wasteTypes.map((type, index) => (
                      <motion.div key={type.name} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 + index * 0.1 }} className={`${type.color} rounded-2xl p-4 text-center`}>
      ...
      {/* ECO QUOTE */}
      <section className="bg-green-50 pt-10 pb-2 px-4 sm:px-6 lg:px-8">
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}>
                  <Card className="bg-white hover:shadow-lg transition-shadow">
                    <CardContent className="p-6 text-center">
                      ...
                      <div className="text-3xl font-bold text-gray-900">{stats?.totalCenters || 5}</div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">How EcoTrack Works</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Our comprehensive platform makes recycling easy, rewarding, and impactful. Start your green journey today.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-3xl p-8 lg:p-16 text-center text-white">
            ...
            <p className="text-lg text-green-100 mb-8 max-w-2xl mx-auto">
              Join thousands of Kenyans who are already making a positive impact on our environment. Sign up today and start earning rewards for your recycling efforts.
            </p>
